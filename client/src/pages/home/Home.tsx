...
function Home() {
  return (
    ...
    <div className='home-side-right'>
        ...
        <p className='home-explanation'>Tiny Heart uses a machine learnign algorithm that helps doctors judge the potential risk of misscariage better.</p>
    ...
    <div id='about-us'>
        ...
        <p className='about-us-text'>Tiny Heart is aiming to optimize the assessment of fetal health made by doctors. We use medical data and analyze it via a trained machine learning model which tries to make an accurate prediction based on previous data to determine the probability of misscariage. The clients are responsible to validate any new data before it is sent to the system in order to keep the databse from having too many invalid entries. </p>
        </div>
